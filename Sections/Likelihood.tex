...
there is at most one point \(t_e\) satisfying the condition \(tt_a(t_e) = \beta\).
...
\begin{align*}
  b_i: (0, \beta_{max}) & \rightarrow \mathcal{D}_{conv}  & g_e: (0, \gamma_{max}) & \rightarrow \mathcal{D}_{conv} \\
